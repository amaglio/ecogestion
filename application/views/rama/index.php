                          ...
                          <tbody>
                            ...
                            <? foreach ($ramas->result() as $row): ?>
                              ...
                              <tr>
                                ...
                                <td> <?=$row->nombre?> </td> 
                                <td> 
                                    <a href="<?=base_url()?>index.php/rama/rama/<?=$row->id_rama?>"><i class="fa fa-2x fa-binoculars" aria-hidden="true"></i></a>
                                </td>
                                <td>
                                    <a href="#" onclick="eliminar_rama(<?=$row->id_rama?>)"><i class="fa fa-2x fa-times" aria-hidden="true" style="padding-left:5px"></i> </a> 
                                </td> 
                              </tr>
